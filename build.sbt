...
libraryDependencies ++= Seq(
  ...
  "com.atlassian.levee" %  "levee-instrumentor" % "1.0-SNAPSHOT" % "runtime",
...
javaOptions in run ++= Seq(
  ...
  "-javaagent:lib_managed/jars/com.atlassian.levee/levee-instrumentor/levee-instrumentor-1.0-SNAPSHOT.jar"
)
